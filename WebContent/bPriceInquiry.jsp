...
PreparedStatement stmt =conn.prepareStatement("select * from goods where productID='"+productid+"'");
...
<tr>
   ...
   <td align="center"><%=rs.getInt("price")%></td>
   <td align="center"><%=rs.getString("infor")%></td>
</tr><%
}
%>
</table> <% 
