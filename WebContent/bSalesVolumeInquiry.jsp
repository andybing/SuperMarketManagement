<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="utf-8"%>
<%@ page language="java" import="java.util.*,java.sql.*,javax.sql.*,java.text.*" %>  
...
PreparedStatement stmt =conn.prepareStatement("select * from sales where productID='"+productid+"' and state='完成'");
...
<tr>
   ...
   <td align="center"><%=rs.getInt("money") %></td>
