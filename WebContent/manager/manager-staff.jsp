	...
	<div class="page-container">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="start active"><a href="manager-staff.jsp"> <i
						class="fa fa-cogs"></i> <span class="title">收银职员管理</span> <span
						class="arrow "></span>
				</a></li>
			...
			<div class="row">
				...
				<div>
					<h2 align="center" color="green">
						...
						<form role="form" action="../Staffadd" method="post" id="addForm">
						...
						<center>
							<!-- <form role="form" class="form-inline" action="staffmodify.jsp">
								<div class="form-group">
									<label for="id" class="col-sm-3 control-label">营业员账号</label>
									<div class="col-sm-8">
		...
		function del(a) {
			if(window.confirm("确定要删除吗?")) {
				document.getElementById("del").action="../Staffdelete?id="+a;
												...
												function(data) {
													...
													for ( var i = 0; i < data.length; i++) {
														...
														html += "<td>"
																...
																+ data[i].id
																+ "' method='post'><input type='button' class='btn btn-danger' onclick='del("+data[i].id+")' value='删除' /></form>"
																+ "</td></tr>";
