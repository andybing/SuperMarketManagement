		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="center-block">
					...
					<form role="form" action="../Modifystaff" method="post" id="modifyForm">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<p class="form-control-static">仓库管理员</p>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="phone" class="form-control" id="phone" id="phone"
	...
	$(document).ready(function(){
		$.getJSON("../Employer",function(data){
			...
			for (var i=0; i < data.length; i++) {
				...
				html += "<td>" +"<form role='form' action='As?id="+data[i].id+"' method='post'><button type='submit' class='btn btn-danger'>修改</button></form>" + "</td></tr>";
