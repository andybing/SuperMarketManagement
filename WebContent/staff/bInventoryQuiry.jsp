<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<%@ page
	import="java.util.*,java.sql.*,javax.sql.*,java.text.*,dao.DbUtil"%>
<%
...
<head>
<meta charset="utf-8" />
<title>Smkt | InventoryQuery</title>
			...
			<div class="row">
				...
				<div>
					...
					<%
						...
						String sql = "";
						if(productid2.trim().length() == 0 || productid2 == null || productid2.trim().equals("")) {
							sql = "select * from storage";
						}else {
							sql = "select * from storage where productID='" + productid2 + "'";
						}
