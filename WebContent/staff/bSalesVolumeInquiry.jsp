<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="utf-8"%>
<%@ page language="java"
	import="java.util.*,java.sql.*,javax.sql.*,java.text.*"%>
...
<title>SMKT | SalesVolumeQuery</title>
</head>
	...
	<div class="page-container">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="start active"><a href="bsalemanagement.jsp"> <i
						class="fa fa-folder-open"></i> <span class="title">销售管理</span> <span
						class="arrow "></span>
				</a></li>
				<li><a href="bcash.jsp"> <i class="fa fa-folder-open"></i>
						<span class="title">收银</span> <span class="arrow "></span>
				</a></li>
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div>
					<!-- 请在这里编辑主页-->
					<%
						String productid = (String) request.getParameter("productID3");
						Connection conn = DbUtil.getConnection();
						String sql = "";
						if(productid.trim().length() == 0 || productid == null || productid.trim().equals("")) {
							sql = "select * from sales where state='完成'";
						}else {
							sql = "select * from sales where productID='" + productid + "' and state='完成'";
						}
					...
					<table border="1" width="600" class="table table-hover">
						...
						<tr>
							...
							<td align="center"><%=rs.getDouble("money")%></td>
