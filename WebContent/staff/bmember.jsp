	...
	<div class="page-container">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class=""><a href="bseenews.jsp"> <i class="fa fa-cogs"></i>
						<span class="title">公告栏</span> <span class="arrow "></span>
				</a></li>
				<li class="start active"><a class="" href="bmember.jsp"> <i
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div>
					<h1 align="center" color="green">添加新会员</h1>
					<form role="form" action="../Addmember" method="post" id="addForm">
						<div class="form-group">

							<label for="mname" class="col-sm-3 control-label"> 会员名称：
							</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label for="adress" class="col-sm-3 control-label"> 家庭地址：
							</label>
							<div class="col-sm-9">
					...
					<!-- <form role="form" class="form-inline" action="bmodify.jsp">
						<div class="form-group">
	...
	<![endif]-->
		...
		function del(a) {
			if(window.confirm("确认删除吗?")) {
				document.getElementById("del").action="../Delete?id="+a;
												...
												function(data) {
													...
													for ( var i = 0; i < data.length; i++) {
														...
														html += "<td>"
																...
																+ "</td>";
														html += "<td>"
																+ data[i].discountlevel
																+ "折" + "</td>";
														html += "<td>"
																+ data[i].validtime
																+ "</td>";
														html += "<td>"
																+ "<form role='form' action='bmodify.jsp?id="
																+ data[i].id
																+ "' method='post'><button type='submit' class='btn btn-danger'>修改</button></form>"
																+ "</td>";
														html += "<td>"
																+ "<form id='del' role='form' action='../Delete?id="
																+ data[i].id
																+ "' method='post'><input type='button' onclick='del("+data[i].id+")' class='btn btn-danger' value='删除' /></form>"
																+ "</td></tr>";
