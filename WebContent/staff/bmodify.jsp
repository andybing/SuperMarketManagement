	...
	<div class="page-container">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li><a href="bsalemanagement.html"> <i
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="center-block">
					...
					<form role="form" action="../Modify" method="post" id="modifyForm">

						<div class="form-group">
							<label class="col-sm-3 control-label" for="formGroupInputLarge">会员账号</label>
							<div class="col-sm-9">
								<p class="form-control-static"><%=rs.getString("id")%></p>
							</div>
						</div>
						...
						<button type="button" onclick="checkForm()" class="btn btn-success" align="center">
							确定修改</button>
						<input type="reset" class="btn btn-success" align="center" />
					</form>
					<br>
					<br>
					<br>
												...
												function(data) {
													...
													for ( var i = 0; i < data.length; i++) {
														...
														html += "<td>"
																...
																+ "</td>";
														html += "<td>"
																+ "<form role='form' action='../As?id="
																+ data[i].id
																+ "' method='post'><button type='submit' class='btn btn-success'>修改</button></form>"
																+ "</td></tr>";
