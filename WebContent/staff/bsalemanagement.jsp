			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown user"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<!-- <li><a href="javascrip:void(0)" id="trigger_fullscreen"><i
								class="fa fa-move"></i> 全屏</a></li>
						<li><a href="javascrip:void(0)"><i class="fa fa-lock"></i>
								锁屏</a></li> -->
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div>
					<!-- 请在这里编辑主页-->
					<form action="bPriceInquiry.jsp" name="form1">
					...
					<form action="bInventoryQuiry.jsp" name="form2">
						<table class="table table-striped">
							<tr>
								<th>商品库存查询：<th>
							</tr>
							<tr bgcolor="#e7e9e9">
								<td>商品编号</td>
								<td><input type="text" name="productID2"></td>
								<td><input type="submit" value="查询"></td>
							</tr>
						</table>
					</form>
					<form action="bSalesVolumeInquiry.jsp" name="form3">
						<table class="table table-striped">
							<tr>
								<th>商品销售查询：<th>
							</tr>
							<tr bgcolor="#e7e9e9">
								<td>商品编号</td>
								<td><input type="text" name="productID3"></td>
								<td><input type="submit" value="查询"></td>
							</tr>
						</table>
					</form>
